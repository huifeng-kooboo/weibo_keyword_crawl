...
search_key_list = ['香港大学','清华大学']

search_config = {
    "begin_time":"2023-01-01-23",  # 开始时间 2022-11-08-1 ： 表示2022年11月8号1时
    "end_time":"2023-01-02-23",  # 结果时间： 2022-11-25-1：表示2022年11月25号1时
    "page" : "4"  # 页码
}
